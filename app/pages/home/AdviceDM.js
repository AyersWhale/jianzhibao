...
import { Text, View, StyleSheet, ScrollView, ImageBackground, Dimensions, Platform, ListView, TextInput, Image, TouchableOpacity, DeviceEventEmitter, BackHandler } from 'react-native';
...
export default class AdviceDM extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#E1E1E1', height: deviceHeight }}>
                <ImageBackground style={{ width: deviceWidth, height: Platform.OS == 'ios' ? (40 + SafeArea.top) : 70, backgroundColor: '#3E7EFE' }}>
                    ...
                    <View style={{ marginTop: Platform.OS == 'ios' ? SafeArea.top : 35, alignSelf: 'center', alignContent: 'center', alignItems: 'center' }}>
                        <Text style={{ color: 'white', backgroundColor: 'transparent', fontSize: Config.MainFontSize + 7, fontWeight: 'bold' }}>帮助</Text>
                    </View>
                </ImageBackground>
