...
export default class RequireTicket extends Component {
    constructor(props) {
        super(props);
                        ...
                        <View>
                            <View style={{ flexDirection: 'column' }}>
                                ...
                                <View style={styles.first}>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        {this.state.M == true ? null :
                                            <Text style={{ color: 'red', fontSize: Config.MainFontSize }}>*</Text>}
                                        <Text style={{ color: "#222222", fontSize: Config.MainFontSize, marginLeft: 10 }}>购方税号</Text>
                                    </View>
                                ...
                                <View style={styles.first}>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text style={{ color: 'red', fontSize: Config.MainFontSize }}>*</Text>
                                        <Text style={{ color: "#222222", fontSize: Config.MainFontSize, marginLeft: 10 }}>购方手机</Text>
                                    </View>
                                    <TextInput
                                ...
                                <View style={styles.first}>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text style={{ color: 'red', fontSize: Config.MainFontSize }}>*</Text>
                                        <Text style={{ color: "#222222", fontSize: Config.MainFontSize, marginLeft: 10 }}>购方邮箱</Text>
                                    </View>
                                    <TextInput
                                        style={{ flex: 1, fontSize: Config.MainFontSize, color: '#999', textAlign: 'right', marginRight: 4, }}
                                        underlineColorAndroid="transparent"
                                ...
                                <View style={styles.first}>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        {this.state.M == true ? null :
                                            <Text style={{ color: 'red', fontSize: Config.MainFontSize }}>*</Text>}
                                        <Text style={{ color: "#222222", fontSize: Config.MainFontSize, marginLeft: 10 }}>购方地址</Text>
                                    </View>
                                    <TextInput
                                        style={{ flex: 1, fontSize: Config.MainFontSize, color: '#999', textAlign: 'right', marginRight: 4, }}
                                        underlineColorAndroid="transparent"
                                ...
                                <View style={styles.first}>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        {this.state.M == true ? null :
                                            <Text style={{ color: 'red', fontSize: Config.MainFontSize }}>*</Text>}
                                        <Text style={{ color: "#222222", fontSize: Config.MainFontSize, marginLeft: 10 }}>购方银行账号</Text>
                                    </View>
                                    <TextInput
                                        style={{ flex: 1, fontSize: Config.MainFontSize, color: '#999', textAlign: 'right', marginRight: 4, }}
                                        underlineColorAndroid="transparent"
                                        ...
                                        keyboardType='numeric'
                                        placeholder={this.state.bankAccount}
                                ...
                                <View style={styles.first}>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text style={{ color: 'red', fontSize: Config.MainFontSize }}>*</Text>
                                        <Text style={{ color: "#222222", fontSize: Config.MainFontSize, marginLeft: 10 }}>金额(元)</Text>
                                    </View>
                                    <Text
                                        style={{ flex: 1, fontSize: Config.MainFontSize, textAlign: 'right', marginRight: 4, }}
    ...
    save() {
        if (this.state.W == false && this.state.M == false) {
            ...
            Toast.showInfo('请填写购方手机', 1000);
            return
        }
        else if (this.state.email == '') {
            Toast.showInfo('请填写购方邮箱', 1000);
            return
        }
        else if (this.state.address == '' && this.state.W == true) {
            Toast.showInfo('请填写购方地址', 1000);
            return
        }
        else if (this.state.account == '' && this.state.bankAccount == '' && this.state.W == true) {
        ...
        var einvoiceOrder = {
            ...
            "account": this.state.info.bankName + " " + this.state.bankAccount,
        ...
        Fetch.postJson(Config.mainUrl + '/invoice/kp', einvoiceOrder)
            .then((res) => {
                Toast.dismiss();
                Toasts.show(res.message, { position: -80 });
                if (res.status == "0000") {
                    Fetch.postJson(Config.mainUrl + '/settleManagement/updateStatsusKpbyId', { list: this.props.rowBack, fpqqlsh: res.fpqqlsh, orderno: this.state.orderno })
                        .then((res2) => {
                            console.log(res2)
                            if (res2) {
                    ...
                    Fetch.postJson(Config.mainUrl + '/invoice/cp', { orderno: his.state.orderno })
                        .then((res2) => {
                        })
                }
            })
